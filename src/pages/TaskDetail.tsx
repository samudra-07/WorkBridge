...
import { getTaskWithBids, getTaskWithClient } from '../data/mockData';
...
import { createBid } from '../data/mockData';
              ...
              <Card className="mb-6">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-2xl font-semibold text-workbridge-700">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {images.map((image, index) => (
                        <div key={index} className="aspect-square overflow-hidden rounded-md">
                          <img src={image} alt={`Task photo ${index + 1}`} className="w-full h-full object-cover" />
                        </div>
                      ))}
                    </div>
                  </CardContent>
                        ...
                        <div key={bid.id} className="flex items-start p-4 bg-gray-50 rounded-lg">
                          ...
                          <div className="ml-4 flex-grow">
                            <div className="flex justify-between items-start">
                              ...
                              <p className="font-semibold text-workbridge-600">₹{bid.amount}</p>
                            </div>
                            {bid.message && (
                      ...
                      <div className="flex items-center text-sm">
                        <span className="flex items-center">
                          {Array(5).fill(0).map((_, i) => (
                            <svg key={i} className={`h-4 w-4 ${i < (client?.rating || 0) ? 'text-yellow-400' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="space-y-3">
                    <div className="group">
                      <Link to="/tasks/task-3" className="block hover:bg-gray-50 p-2 rounded-md">
                        <p className="font-medium group-hover:text-workbridge-600">Living Room Painting</p>
                        <p className="text-sm text-gray-500">₹5,000 - ₹8,000</p>
                      </Link>
                    </div>
                    <div className="group">
                      <Link to="/tasks/task-4" className="block hover:bg-gray-50 p-2 rounded-md">
                        <p className="font-medium group-hover:text-workbridge-600">Furniture Delivery and Assembly</p>
                        <p className="text-sm text-gray-500">₹1,500 - ₹2,500</p>
                      </Link>
                    </div>
                    <div className="group">
                      <Link to="/tasks/task-5" className="block hover:bg-gray-50 p-2 rounded-md">
                        <p className="font-medium group-hover:text-workbridge-600">Digital Marketing Strategy</p>
