...
const Index = () => {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-workbridge-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 flex justify-center">
              <div className="relative w-full max-w-lg">
                <div className="absolute top-0 -left-4 w-72 h-72 bg-workbridge-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">How WorkBridge Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-6 text-center">
                <div className="h-12 w-12 rounded-full bg-workbridge-100 flex items-center justify-center mx-auto mb-4">
                  <MapPin className="h-6 w-6 text-workbridge-600" />
                </div>
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-6 text-center">
                <div className="h-12 w-12 rounded-full bg-workbridge-100 flex items-center justify-center mx-auto mb-4">
                  <Search className="h-6 w-6 text-workbridge-600" />
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {CATEGORIES.map((category) => (
              <Link 
                ...
                className="group"
              >
                <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-workbridge-200 hover:shadow-sm transition-all">
                  <div className="h-12 w-12 rounded-full bg-workbridge-100 flex items-center justify-center mx-auto mb-4 group-hover:bg-workbridge-200 transition-colors">
                    {/* Use category.icon to choose icon, falling back to a default */}
                    {category.icon === 'home' ? (
                      <svg className="h-6 w-6 text-workbridge-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h3 className="font-medium group-hover:text-workbridge-600 transition-colors">
                    {category.name}
                  </h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/tasks" className="text-workbridge-600 hover:text-workbridge-700 flex items-center font-medium">
              View All
      ...
      <section className="py-16 hidden md:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-600">
              Hear from workers and clients who've used WorkBridge
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-6 relative">
                ...
                <div className="pt-4">
                  <p className="text-gray-600 mb-4">
                    As a painter, WorkBridge has helped me find consistent work in my area. The platform is easy to use and I can set my own rates.
                  </p>
                  <div className="flex items-center">
                    <div className="h-10 w-10 rounded-full overflow-hidden mr-3">
                      <img 
      ...
      {/* CTA Section */}
      <section className="py-12 bg-workbridge-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            <Button asChild size="lg" variant="outline" className="text-white border-white hover:bg-workbridge-700">
              <Link to="/post-task">Post a Task</Link>
            </Button>
